        ...
        <div className="flex justify-center items-center gap-x-5">
            ...
            <div className="w-[250px] h-[380px] bg-white rounded-xl flex items-start relative overflow-hidden dropsample">
                <div className="w-auto h-full">
                    ...
                    width="250"/>
                    <div className="p-3">
                        <h1 className="text-[24px] text-center font-bold">Smaragda Reppa </h1>
                        <h2 className="text-[17px] text-center">Software Development</h2>
                    </div>
            ...
            <div className="w-[250px] h-[380px] bg-white rounded-xl flex items-start relative overflow-hidden dropsample">
                <div className="w-auto h-full">
                    ...
                    width="250"/>
                    <div className="p-3">
                        <h1 className="text-[24px] text-center font-bold">Konstantinos Theofilis</h1>
                        <h2 className="text-[17px] text-center">Software Development</h2>
                    </div>
            ...
            <div className="w-[250px] h-[380px] bg-white rounded-xl flex items-start relative overflow-hidden dropsample">
                <div className="w-auto h-full">
                    ...
                    width="250"/>
                    <div className="p-3">
                        <h1 className="text-[24px] text-center font-bold">George Ganias</h1>
                        <h2 className="text-[17px] text-center">Software Development</h2>
                    </div>
